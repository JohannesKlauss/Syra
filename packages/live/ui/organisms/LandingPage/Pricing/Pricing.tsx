    ...
    <Flex align={"space-around"} marginY={12} marginX={32}>
      <Box flex={1}>
        ...
        <Text fontSize={"2xl"} fontWeight={600} marginY={12}>
          ...
          The essentials packages has everything you need to get you started.<br/>
          If you need more tracks and more collaboration features, Standard might be for you.<br/>
          To get you really started, get yourself the Studio package to enable
