...
import { Avatar, Box, Divider, Flex, Link as ChakraLink, Text } from '@chakra-ui/core';
...
import { DisplayFeedItemFragment } from '../../../../gql/generated';
import Link from 'next/link';

interface Props {
  feedItem: DisplayFeedItemFragment;
}
        ...
        <Flex align={'center'}>
          ...
          <Box marginLeft={4}>
            <Link passHref href={`profile/${feedItem.author.handle}`}>
              <ChakraLink fontWeight={600} fontSize={'sm'}>{feedItem.author.name}</ChakraLink>
            </Link>
